...
go
/*
1)Seleccionar el ingreso total por cliente en 1997 y ordenado 
por el ingreso de forma descendente
*/
...
/*
2)Selecionar  los productos por categorias mas vendido  (Unidades),
Enciados Alemania Ordenados Por Categoria Y Dentro De Categotia
...
GO
/*
3)Seleccionar empleados con mas pedidos realizados por año,
